(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/meta2.loader.js";
    var config = {
        dataUrl: buildUrl + "/meta2.data",
        frameworkUrl: buildUrl + "/meta2.framework.js",
        codeUrl: buildUrl + "/meta2.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "DefaultCompany",
        productName: "Taipei house Meta",
        productVersion: "0.1",
    };
